                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 m-b-20">
                            ...
                            <ul class="nav nav-tabs">
                               ...
                               <!--  <li><a href="#tab3" data-toggle="tab">Specifications</a></li>
                                ...
                                <li><a href="#tab5" data-toggle="tab">Downloads</a></li> -->
                                <li><a href="#tab6" data-toggle="tab">SEO Context</a></li>
                            </ul>
                            <!-- Tab panels -->                            
                                ...
                                <div class="panel-body">                                        
                                 <p><code class="highlighter-rouge">*</code> Fields Are Mandatory</p>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="post_name" id="field_name" placeholder="Product Name" onkeyup="mytext(this.value,this.id);" onblur="makeurl(this.value);check_duplicate(document.getElementById('slug_url').value);" required ids='post' types = 'Product'>
                                            <span style="color: rgb(153, 0, 0); display: none;"  id="inline_red">Product Already Exist. Please try another Page Name.</span> 
                                        <span style="color: rgb(0, 102, 0); display: none;" id="inline_green">URL Available</span> 
                                        </div>
                                    </div>                                      
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Product URL&nbsp;<span class="red">*</span></label>
                                        <div class="col-sm-9">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                              ...
                                              <div class="col-sm-9">
                                                  <textarea class="form-control" name="side_desc" id="editor2" placeholder="Full Description"></textarea>
                                                    <script>
                                    ...
                                    <div id="ftr_div">    
                                     <div class="row">
                                        <div class="col-md-12">
                                          <fieldset>  
                                              <div class="form-group row">
                                                  <label class="col-sm-2 col-form-label">Desription</label>
                                                  <div class="col-sm-10">
                                                      <textarea class="form-control" name="full_desc" id="editor5"></textarea>
                                                        <script>
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="form-group row">
                                                     ...
                                                     <div class="form-group row">
                                                      ...
                                                      <div class="col-sm-10">
                                                         <textarea class="form-control" rows="3" name="canonical_code" id="canonical_code" placeholder="<link rel=“canonical” href=“<?=base_url('product/productname')?>” />"></textarea>
                                                      </div>
                                                   </div>
                                                  <div class="form-group row">
