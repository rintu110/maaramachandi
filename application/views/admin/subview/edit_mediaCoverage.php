                    ...
                    <p><code class="highlighter-rouge">*</code> Fields Are Mandatory</p>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4" id="datepick">
                           <input class="form-control" type="text" name="publish_date"  placeholder="Publish Date" required="required" readonly="readonly" value="<?=($all_data->publish_date !='')?date('d/m/Y',strtotime($all_data->publish_date)):''?>">
                        </div>  
                       <label class="col-sm-2 col-form-label">URL (if any)</label>
                        <div class="col-sm-4">
                            <input class="form-control" type="text" placeholder="URL" name="link" value="<?=$all_data->link?>">                             
                        </div>                      
                    </div>                                                                  
                        ...
                        <div class="col-sm-4">
                            ...
                            <p><img id="imagePreview" style="display:none; max-width: 600px; margin-top: 10px;"/></p>
                              <?php  
                                    ...
                                    {  
                                ?>
                                           <img src="<?=base_url('post/mediaCoverage/'.$all_data->cut_img)?>">
                                           <br>  
                                           <input type="button" name="" value="Remove" class="btn btn-sm btn-danger Delete_Img" ids="<?=$all_data->id?>" tbl="m_media_coverage" col_name = "cut_img" dest = "post/mediaCoverage" dest_thumb = "post/mediaCoverage//thumb">   
                                <? 
                                   } 
                              ?>      
                       </div>                  
