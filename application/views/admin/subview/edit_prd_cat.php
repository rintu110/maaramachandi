                      ...
                      <div class="tab-pane fade in active" id="tab1"> 
                       <div class="panel-body">
                          <p><code class="highlighter-rouge">*</code> Fields Are Mandatory</p>
                              ...
                              <div class="form-group row">
                               ...
                               <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                      <input class="form-control" type="text" placeholder="Heading" name="heading" value="<?=$all_data->heading?>">
                                  </div>
                              </div>
                               <div class="form-group row">
                                            ...
                                            foreach ($category as $v) 
                                            {
                                               ...
                                               if(sizeof($q) > 0)
                                               {
                                                   foreach ($q as $v1) 
                                                   {
                                                      ...
                                                      /* $qq = $this->db->query("SELECT id,cat_name FROM category where parent_id = '".$v1->id."' AND post_type = 'Product'")->result(); 

                                                       print_result($qq); 

                                                       if(sizeof($qq) > 0 && is_array($qq)) 
                                                       {
                                                           $inner_cat = '';
                                                           foreach ($qq as $v2) 
                                                           {    
                                                               ...
                                                               $inner_cat .= '<option value="'.$v2->id.'" '.$sel.'>&nbsp;&nbsp;--&nbsp;&nbsp;&nbsp;&nbsp;'.$v2->cat_name.'</option>'; 
                                                           }
                                                       }*/
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <textarea class="form-control" name="full_dsc" id="editor2"><?=$all_data->full_dsc?></textarea>
                                    <script>
                              ...
                              <div class="col-sm-9"> 
                                <input type="file" class="form-control"  name="post_img" id="fileInput">       
                                      ...
                                      <?php  if($all_data->post_img !='')  {  ?>
                                         ...
                                         <br>  
                                         <input type="button" name="" value="Remove" class="btn btn-sm btn-danger Delete_Img" ids="<?=$all_data->id?>" tbl="category" col_name="post_img" dest="post" dest_thumb="post/thumb">   
                                     <? } ?>                                                   
                              </div>
                           </div>
                           <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                        <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                  ...
                                                  <div class="col-sm-10">
                                                     <textarea class="form-control" rows="3" name="canonical_code" id="canonical_code" placeholder="<link rel=“canonical” href=“<?=base_url('categoryname')?>” />"><?=$all_data->canonical_code?></textarea>
                                                  </div>
                                               </div>
                                                <div class="form-group row">
