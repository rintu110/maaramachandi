                ...
                <div class="row">
                        <form method="post" name="frm_page" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                  <fieldset>                                                                                            
                                      <div class="form-group row">
                                          <label class="col-sm-2 col-form-label">Technical Information&nbsp;<span class="red">*</span></label>
                                          <div class="col-sm-10">
                                              <textarea class="form-control" name="composition" id="editor4"><?=$all_data->composition?></textarea>
                                                <script>
                          ...
                          <div class="form-group row">                                
                            ...
                            <button type="button" class="btn btn-default" onclick="window.location='<?=base_url('admin/edit_spec/'.$this->uri->segment(3))?>'">Cancel</button>
                        </div>                       
                       </form>
                    </div> 
  ...
  // $(document).ready(function(){
     $("#cnt_add").click(function(){
        ...
        $("#ftr_div").append('<div id="ftr_div'+rowCount+'">'
          ...
          //New Specification Add
           $(".new_specs").click(function(){
              rowCounts ++;
              rowCnts ++;
              $("#new_spec").append('<div id="new_spec'+rowCounts+'">'
                                    +`<div class="row">
                                      <div class="col-md-12">                   
                                            <div class="form-group row">
                                              <div class="col-sm-2">
                                              ...
                                              <div class="col-sm-1">
                                                 <label>&nbsp;</label><br>`    
                                                 +'<input type="button" name="" value="+" id="attr_add'+rowCounts+'" class="btn btn-success attr_adds">'
                                              +`</div> 
                                              <div class="col-sm-2">
                                                   <label>&nbsp;</label><br>`    
                                                 +'<input type="button" value="X" onClick = "removeDiv(\'new_spec'+rowCounts+'\')" id="remove_btn" class="btn btn-danger">'
                                              +`</div>  
                                            </div>
                                      </div>
                                    </div>`);
        ...
        //  }); 
           ...
           var nested_div = '<div id="new_spec'+rowCnts+'">'
                                          +`<div class="row">
                                            <div class="col-md-12">                   
                                             <div class="form-group row">
                                               <div class="col-sm-2">                                                                                       
                                               ...
                                               <div class="col-sm-1">
                                                 <label>&nbsp;</label><br>`
                                                +'<input type="button" value="X" onClick = "removeDiv(\'new_spec'+rowCnts+'\')" id="remove_btn" class="btn btn-danger">'
                                               +`</div>                                                
                                               </div>
                                              </div>
                                        </div>`;
          ...
          //New Attribute Add In nested 
           var subcat_div = '<div id="new_spec'+rowCounts+'">'
                                +`<div class="row">
                                  <div class="col-md-12">                   
                                  <div class="form-group row">
                                    <div class="col-sm-2">
