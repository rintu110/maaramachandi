   ...
   <section class="fixed content-header">  
    ...
    <div class="header-title">
        ...
        <div class="breadcrumb">
            <button type="button" class="btn btn-black" onclick="window.location='<?=base_url('admin/gallerylist')?>'">
             ...
             <button type="button" class="btn btn-info" onclick="window.location='<?=base_url('admin/gallery')?>'">
...
<script type="text/javascript">
        ...
        jQuery(document).ready(function() { 
          ...
          $('#submit').click(function(){
                ...
                // AJAX request
                $.ajax({
                    url: '<?=base_url()?>admin/upload_img_gallery/'+ids,
                    type: 'post',
                    data: form_data,                    
                    dataType: 'json',
                    contentType: false,
                    ...
                    success: function (data) {
                        ...
                        {    
                             ...
                             $("#success").click();
                             window.location.href = '<?=base_url('admin/gallerylist')?>'
                             //location.reload();     
                        }
                        else if(result == 0)
                        {
