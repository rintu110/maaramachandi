                ...
                <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 m-b-20">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab1" data-toggle="tab">Quality Control</a></li>
                                <li><a href="#tab2" data-toggle="tab">Enganche Style</a></li>
                               <!--  <li><a href="#tab3" data-toggle="tab">Key Highlights</a></li>
                                <li><a href="#tab4" data-toggle="tab">Core Value</a></li>       -->                          
                            </ul>
                            <!-- Tab panels -->                            
