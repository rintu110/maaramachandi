            ...
            <div class="panel panel-bd ">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h4>Prodduction & Technology Conent</h4>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 m-b-20">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab1" data-toggle="tab">The Dorway</a></li>
                                <li><a href="#tab2" data-toggle="tab">Production Process</a></li>
                                <li><a href="#tab3" data-toggle="tab">Technology</a></li>
                                <li><a href="#tab4" data-toggle="tab">Design Y Development</a></li>                                
                            </ul>
                            <!-- Tab panels -->                            
                                       ...
                                       <div class="col-md-12">
                                        <fieldset>                                                                                            
                                         <div class="form-group row">
                                          <label class="col-sm-2 col-form-label">Content&nbsp;<span class="red">*</span></label>
                                           <div class="col-sm-10">
                                            <textarea class="form-control" name="tech_info" id="editor4"></textarea>
                                             <script>
                                        ...
                                        <div class="col-md-12">
                                          <fieldset>
                                              <div class="form-group row">
                                                  <label class="col-sm-2 col-form-label">Content&nbsp;<span class="red">*</span></label>
                                                  <div class="col-sm-10">
                                                      <textarea class="form-control" name="composition" id="editor5"></textarea>
                                                        <script>
                                          ...
                                          <div class="col-md-12">
                                            <fieldset>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Content&nbsp;<span class="red">*</span></label>
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" name="composition" id="editor6"></textarea>
                                                          <script>
