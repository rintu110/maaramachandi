                  ...
                  <div class="panel-body">
                    <p><code class="highlighter-rouge">*</code> Fields Are Mandatory</p>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="text" name="purpose"  placeholder="Purpose" required="required">
                        </div>
                        <label class="col-sm-2 col-form-label">Booking Date&nbsp;<span class="red">*</span></label>
                          <div class="col-sm-4" id="datepick">
                            <input class="form-control" type="text" name="dates"  placeholder="Booking Date" required="required" readonly="readonly">
                        </div>
                    </div>  
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="text" placeholder="Gotra" name="gotra">                             
                        </div>
                    </div>  
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Address&nbsp;<span class="red">*</span></label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" placeholder="Name" name="address"  required="required">
                        </div>                        
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Yearly Donation&nbsp;<span class="red">*</span></label>
                        <div class="col-sm-2">
                            <input class="form-control" type="text" placeholder="Yearly Donation" name="yrly_donation"  required="required">
                        </div>                        
                    </div>                    
